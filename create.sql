create table author (birth_date date, death_date date, work_count integer not null, id bigint not null auto_increment, author_key varchar(255), biography varchar(255), name varchar(255), top_work varchar(255), primary key (id)) engine=InnoDB;
...
create table book (page_count integer not null, publish_date date, id bigint not null auto_increment, book_key varchar(255), description varchar(255), language varchar(255), title varchar(255), primary key (id)) engine=InnoDB;
...
create table summaryDto (average float(53) not null, count integer not null, sortable_average float(53), id bigint not null auto_increment, primary key (id)) engine=InnoDB;
...
alter table rating add constraint FKsoec5tjdl6a14aahd17upf9v foreign key (summary_id) references summaryDto (id);
